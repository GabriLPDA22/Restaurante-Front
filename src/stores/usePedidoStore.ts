...
export const usePedidoStore = defineStore('pedido', () => {
    ...
    const cargarTodosLosProductos = async () => {
        ...
        try {
            ...
            const { data } = await axios.get('https://elixiumapi.retocsv.es/api/Productos');
            ...
            try {
                const { data } = await axios.get('https://elixiumapi.retocsv.es/api/Categorias');
    ...
    const obtenerPedidosUsuario = async () => {
        ...
        try {
            ...
            const { data } = await axios.get(`https://elixiumapi.retocsv.es/api/Pedido/usuario/${userId}`);
    ...
    const obtenerPedidoPorId = async (pedidoId: number) => {
        ...
        try {
            ...
            const { data } = await axios.get(`https://elixiumapi.retocsv.es/api/Pedido/${pedidoId}`);
    ...
    const procesarPedido = async (productosCarrito: ProductoCarrito[], userId: number) => {
        ...
        try {
            ...
            const { data } = await axios.post(
                'https://elixiumapi.retocsv.es/api/Pedido',
                pedidoDto,
