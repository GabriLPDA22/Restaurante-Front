...
const probarGetPedidos = async () => {
    ...
    try {
        const response = await axios.get('https://elixiumapi.retocsv.es/api/Pedido/usuario/1', {
            headers: {
...
const probarPostPedido = async () => {
    ...
    try {
        ...
        const response = await axios.post('https://elixiumapi.retocsv.es/api/Pedido', pedidoData, {
            headers: {
...
const handleError = (error: any) => {
    ...
    if (error.response) {
        ...
        resultado.value = `No se recibió respuesta del servidor.\nVerifica que el servidor esté funcionando en https://elixiumapi.retocsv.es/`;
    } else {
