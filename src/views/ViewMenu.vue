...
const categories = ref(["All", "Appetizers", "Main Courses", "Drink", "Dessert"]);
...
const menuData = ref([
    ...
    { id: 3, category: "Drink", name: "Mojito", price: 10, image: "image3.png", description: "Refreshing mint cocktail", rating: 5 },
