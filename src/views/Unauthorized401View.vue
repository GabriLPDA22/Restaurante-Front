...
// Función para ir a la página de login de administrador
const goToLogin = () => {
    router.push('/admin');
};
</script>
...
.unauthorized-container {
    ...
    align-items: center;
    min-height: 100vh;
    background: linear-gradient(135deg, #1e3a40, #0d1b1e, #2c3e50, #182830);
    padding: 20px;
}
...
.error-card::before {
    ...
    right: 0;
    height: 6px;
    background: linear-gradient(to right, #f5365c, #e14eca);
}
